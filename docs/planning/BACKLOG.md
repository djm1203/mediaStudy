...
| B-009 | [ALL] | **E6** — Keep README/docs in sync with implementation (model routing, feature list, TUI) as an ongoing DoD check | LOW | None | Pending |
